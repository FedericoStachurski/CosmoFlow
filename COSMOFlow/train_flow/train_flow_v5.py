...
def read_data(batch):
    path_name ="data_gwcosmo/empty_catalog/training_data_from_MLP/"
    data_name = "name_training_data_O1_catalog_False_band_K_batch_1_N_1000000_SNR_11_Nelect_5__Full_para_v1.csv".format(batch)
...
data = data[['xcoord', 'ycoord', 'zcoord', 'mass_1', 'mass_2', 'theta_jn', 'psi', 'geocent_time', 'H0']]
