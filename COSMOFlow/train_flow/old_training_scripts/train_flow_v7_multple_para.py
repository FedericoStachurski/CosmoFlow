...
def read_data(batch_of_data):
    ...
    data_name ="run_O3_det_['H1', 'L1', 'V1']_name_test_multiple_para_catalog_True_band_K_batch_{}_N_100000_SNR_11_Nelect_5__Full_para_v1.csv".format(batch_of_data)
    GW_data = pd.read_csv(path_name+data_name,skipinitialspace=True, usecols=['H0', 'gamma', 'kappa','zp', 'luminosity_distance', 
...
if xyz == 1:
    data = data[['xcoord', 'ycoord', 'zcoord', 'mass_1', 'mass_2', 'H0', 'gamma', 'kappa','zp']]
else: 
    data = data[['luminosity_distance', 'ra', 'dec', 'mass_1', 'mass_2', 'H0', 'gamma', 'kappa','zp']]
