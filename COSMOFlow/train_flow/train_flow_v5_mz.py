...
def read_data(batch):
    ...
    GW_data = pd.read_csv(path_name+data_name,skipinitialspace=True, usecols=['H0', 'dl','m1', 'm2','a1', 'a2', 'tilt1', 
                                                                             ...
                                                                             'phi_12', 'polarization', 'geo_time', 'app_mag'])
    return GW_data
...
z = cosmology.fast_dl_to_z_v2(dl,H0)
...
data = GW_data[['dl','m1', 'm2','a1', 'a2', 'tilt1', 'tilt2', 'RA', 'dec', 'theta_jn', 'phi_jl', 
                                                                             'phi_12', 'polarization', 'geo_time','app_mag', 'z', 'H0']]
...
kl_dict =  dict(KL_vals1 = [], KL_vals2 = [], KL_vals3 = [], KL_vals4 = [], KL_vals5 = [], KL_vals6 = [], KL_vals7 = [], 
               KL_vals8 = [], KL_vals9 = [], KL_vals10 = [], KL_vals11 = [], KL_vals12 = [], KL_vals13 = [], KL_vals14 = [],
               KL_vals15 = [], KL_vals16 = [])
