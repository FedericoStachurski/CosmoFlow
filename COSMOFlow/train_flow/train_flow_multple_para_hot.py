...
print('batches data = {}'.format(batches_data))
...
def read_data(batch_of_data):
    ...
    data_name ="run_O3_det_['H1', 'L1', 'V1']_name_test_hot_catalog_True_band_K_batch_{}_N_100000_SNR_11_Nelect_5__Full_para_v1.csv".format(batch_of_data)
    print(data_name)
    GW_data = pd.read_csv(path_name+data_name,skipinitialspace=True, usecols=['snr', 'H0','gamma','kappa','zp',
                                                                              'alpha', 'beta','mmax', 'mmin',
                                                                              'mu_g', 'sigma_g', 'lambda_peak', 'delta_m',                                                                                             'luminosity_distance', 'mass_1', 'mass_2', 'ra',
                                                                              'dec','a_1', 'a_2', 'tilt_1',
                                                                              'tilt_2','theta_jn','phi_jl', 'phi_12',
                                                                              'psi','geocent_time', 'app_mag', 
                                                                              'H1', 'L1', 'V1','inx'])
    return GW_data
...
if xyz == 1:
    data = data[['xcoord', 'ycoord', 'zcoord', 'mass_1', 'mass_2', 'H0', 'gamma', 'mmax', 'mu_g', 'H1','L1','V1']]
else: 
    data = data[['luminosity_distance', 'ra', 'dec', 'mass_1', 'mass_2', 'H0', 'gamma', 'mmax', 'mu_g', 'H1','L1','V1']]
