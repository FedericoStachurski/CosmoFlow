...
def read_data(batch):
    ...
    data_name = "_data_500000_N_SNR_10_Nelect_10__Full_para_v2.csv".format(batch)
...
fig = corner.corner(data[['xcoord', 'ycoord', 'zcoord', 'm1', 'm2','a1', 'a2', 'tilt1', 'tilt2', 'theta_jn', 'phi_jl','phi_12', 'polarization', 'geo_time']] , plot_datapoints=False, smooth = True, fig = c1, levels = (0.5, 0.9), plot_density=True,labels=[r'$x[Mpc]$',r'$y[Mpc]$',r'$z[Mpc]$', r'$m_{1,z}$', r'$m_{2,z}$',r'$a_{1}$', r'$a_{2}$', r'$tilt_{1}$', r'$tilt_{2}$',
r'$\theta_{JN}$', r'$\phi_{JL}$',  r'$\phi_{12}$',r'$\psi$', r'$t_{geo}$'], hist_kwargs = {'density' : 1})
