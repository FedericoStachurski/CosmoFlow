...
def read_data(batch_of_data):
    ...
    data_name ="run_O3_det_['H1', 'L1', 'V1']_name_BBH_O3_H0_old_NSBH_190814_catalog_True_band_K_batch_{}_N_100000_SNR_11_Nelect_2__Full_para_v1.csv".format(batch_of_data)
    print(data_name)
