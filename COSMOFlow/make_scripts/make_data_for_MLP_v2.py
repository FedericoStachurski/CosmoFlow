...
dlsample = np.random.uniform(10,20_000,N)
m1zsample = np.random.uniform(5,200,N)
m2zsample = np.random.uniform(5,200,N)
...
if type_data == 'testing':
    ...
    df.to_csv(path_data+'_data_{}_full_para_v1_batch_1.csv'.format(N))
