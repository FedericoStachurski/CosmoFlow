...
if type_of_data == 'training':
    ...
    path_data = r"/data/wiay/federico/PhD/gwcosmoFLow_v2/data_gwcosmo/in&out_events_mock_cat_zmax_"+str(int(zmax))+"_mth_"+str(int(mth))+"_v3/training_data/"
